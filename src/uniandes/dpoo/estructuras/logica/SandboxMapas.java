...
public class SandboxMapas
{
    ...
    {
        Collection<String> value = mapaCadenas.values();
        List<String> listvalue = new ArrayList<>(value);
    ...
    public Collection<String> getLlaves( )
    {
        ...
        Collection<String> keysMay = new ArrayList<>();
        for(String llave : llaves)
        {
        	keysMay.add(llave.toUpperCase());
    ...
    {
        Collection<String> value = mapaCadenas.values();
        Set<String> unicos = new HashSet<>(value);
    ...
    public boolean compararValores( String[] otroArreglo )
    {
        for (String elemento: otroArreglo) {
        	...
        	if (!mapaCadenas.containsKey(elemento)) {
